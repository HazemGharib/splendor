  ...
  return (
    <Modal open={open} onOpenChange={setOpen}>
      ...
      <ModalContent className="max-w-2xl max-h-[80vh] overflow-y-auto">
        <ModalHeader>
          <ModalTitle>How to Play Splendor</ModalTitle>
          <ModalDescription>Quick reference guide</ModalDescription>
        </ModalHeader>
        ...
        <div className="space-y-4 py-4 text-sm">
          ...
          <section>
            <h3 className="font-semibold mb-2">Actions (choose one per turn)</h3>
          ...
          <section>
            <h3 className="font-semibold mb-2">Cards & Bonuses</h3>
            <p className="text-gray-300">
          ...
          <section>
            <h3 className="font-semibold mb-2">Nobles</h3>
            <p className="text-gray-300">
